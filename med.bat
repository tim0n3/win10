...
:: Stop/Limit Microsoft Eavesdropping
...
:: Cleanup
:: Remove reminants of script if previously run.
...
:: Stop/Limit Microsoft Eavesdropping/unneeded services.
net stop DiagTrack
...
:: Harden Privacy - Delete, or disable, unneeded services.
